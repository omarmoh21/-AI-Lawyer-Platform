...
from core.agents.legal_research_agent import legal_research_agent
from core.agents.document_agent import document_agent
from core.agents.contract_agent import contract_agent
